...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    {
      ...
      name: "Classic",
      preview:
        "A clean, traditonal resume format with clear sections and professional typography",
    },
    {
      id: "modern",
      name: "Modern",
      preview:
        "sleek design with startagic use of color and modern font choices",
    },
    {
      id: "minimal-image",
      name: "Minimal Image",
  ...
  return (
    ...
    from-blue-50 to-blue-100 ring-blue-300 hover:ring transition-all px-3 py-2 rounded-lg"
      ...
      {isOpen && (
        <div
          className="absolute top-full w-xs p-3 mt-2 space-y-2 z-10 bg-white
