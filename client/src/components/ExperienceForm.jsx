    ...
    <div className='space-y-6'>
      ...
      {data.length===0?(
        <div className='text-center py-8 text-gray-500'>
          <Briefcase className='w-12 h-12 max-auto mb-3 text-gray-300'/>
          ...
          {data.map((experience,index)=>(
            ...
            rounded-lg space-y-3'>
              ...
              <div className='grid md:grid-cols-2 gap-3'>
                <input onChange={(e)=>updateExperience(index,"company",e.target.value)}
                 value={experience.company || ""}
                type="text" placeholder='company name'
                className='px-3 py-2 text-sm rounded-lg' />

                <input onChange={(e)=>updateExperience(index,"position",e.target.value)}
                 value={experience.position  || ""}
                type="text" placeholder='Job Title'
                className='px-3 py-2 text-sm rounded-lg' />


                <input onChange={(e)=>updateExperience(index,"start_date",e.target.value)}
                 value={experience.start_date || ""}
                type="month"
                className='px-3 py-2 text-sm rounded-lg' />

                <input onChange={(e)=>updateExperience(index,"end_date",e.target.value)}
